  ...
  return (
    <>
      <Box sx={{ backgroundColor: "#141A1F", padding: 0, margin: 0 }}>
          ...
          <Grid container>
            <Grid item xs={12} style={aboutTitleStyle}>
              ...
              >
                ...
                drumming productions. We’ll tailor-make our show to best fit
                your event needs and venue.
              </Typography>
            </Grid>
          </Grid>
        </Box>
        ...
        <Box>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={8} lg={8}>
              ...
              >
                Ignite your event with our choreographed, high energy drumming
                that will get your guests jumping out of their chairs!
              </Typography>
            </Grid>
            <Grid
              item
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              >
                Your event will take center stage when the Rhythm Messengers
                make their appearance. Your guests will jump, stomp and dance
                your event away!
              </Typography>
            </Grid>
          </Grid>
        ...
        <Grid
          container
          style={{ backgroundColor: "#f5f5f5", paddingTop: "50px" }}
        >
          <Grid
            item
            xs={12}
          ...
          >
            ...
            <Typography
              ...
              style={{ fontSize: "18px", fontWeight: "300", padding: "30px" }}
            >
              Kick off the meeting with an electrifying and high energy
              atmosphere.
            </Typography>
          </Grid>
        </Grid>
